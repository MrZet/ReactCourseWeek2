...
export const getRemainingTimeboxes = (state) => state.filter(timebox => timebox.id !== state.currentStartedTimeboxId);
export const getTimeboxById = (state, timeboxId) => state.find(t=>t.id === timeboxId);
